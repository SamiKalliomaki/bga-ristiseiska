 ...
 * gameoptions.inc.php
 *
 * Ristiseiska game options description
 * 
 ...
 *        with the same ID (see "initGameStateLabels" in ristiseiska.game.php)
 *
...
$game_options = array(
    ...
    */
    ...
    100 => array(
        ...
        'values' => array(
            -200 => array( 'name' => totranslate('Multi-round (-200)'), 'description' => totranslate('The game ends when first player reaches -200 points.')),
            -100 => array( 'name' => totranslate('Multi-round (-100)'), 'description' => totranslate('The game ends when first player reaches -100 points.')),
            -1 => array( 'name' => totranslate('Single round'), 'description' => totranslate('The game ends immediately after the first round.') ),
        ),
        'default' => -200,
    ),
